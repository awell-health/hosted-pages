...
const VISIBLE_SESSION_POLLING_INTERVAL_MS = 2000
const HIDDEN_SESSION_POLLING_INTERVAL_MS = 60000
...
const Home: NextPageWithLayout = () => {
  ...
  // Register hosted session polling with connectivity. Keep a slower hidden-tab
  // fallback so activity state can still reconcile if subscriptions are missed.
  useEffect(() => {
    ...
    const cleanup = registerPollingTask({
      start: (pollingMode) => {
        const pollInterval =
          pollingMode === 'visible'
            ? VISIBLE_SESSION_POLLING_INTERVAL_MS
            : HIDDEN_SESSION_POLLING_INTERVAL_MS
