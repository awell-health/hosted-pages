...
export type CalculationInput = {
  ...
  data_point_value: DataPointValueType;
};
...
export type OrchestratedAgent = {
  ...
  worker_agent_id: Scalars['String'];
};
